...
import ninja from './cnn.png';

const Footer = () => {
  return (
    <footer className="bg-black text-white py-16 sm:py-32 md:py-40 lg:py-60">
      ...
      <div className="text-center">
        ...
        <div className="flex items-center justify-center">
          ...
          <span className='text-white text-2xl'>khemnanikarishma111@gmail.com</span>
        </div>
      </div>
