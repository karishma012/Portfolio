  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 p-4">
      ...
      <div className="flex flex-wrap justify-center">
        ...
        {/* FRONTEND SECTION */}
        <div className=" max-w-md mx-auto flex flex-col items-center border border-purple-600 p-8 rounded-lg m-4">
        ...
        {/* BACKEND SECTION */}
        <div className="max-w-md mx-auto flex flex-col items-center mx-3 border border-purple-600 p-8 rounded-lg m-4">
          <h3 className="text-2xl font-bold mb-4 text-white font-serif">BACKEND</h3>
          <div className='flex flex-wrap justify-center'>
          <p className='max-w-md mx-auto flex text-white border border-white p-2 mt-2 mx-3 rounded-xl '>
          <img src="https://e7.pngegg.com/pngimages/343/191/png-clipart-database-computer-icons-microsoft-sql-server-database-miscellaneous-black.png" alt="Node Icon" className=" h-4 mr-2 " />
           SQL
            ...
            <p className='flex px-2 max-w-md mx-auto text-white border border-white p-2 mt-2 mx-2 rounded-xl'>
